...
struct ImGui_ImplVulkan_InitInfo
{
    ...
    VkFormat                        DepthAttachmentFormat;  // Made by Hullu Kana, developer of Vulkano, itself. Not necessary for ImGui, but is necessary to fix a validation layer error.
