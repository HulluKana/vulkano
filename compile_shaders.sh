...
/usr/local/bin/glslc Shaders/src/screenObj.vert -o Shaders/bin/screenObj.vert.spv
/usr/local/bin/glslc Shaders/src/screenObj.frag -o Shaders/bin/screenObj.frag.spv