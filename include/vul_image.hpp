...
class VulImage {
    public:
        ...
        void transitionImageLayout(VkImageLayout oldLayout, VkImageLayout newLayout, VkCommandBuffer cmdBuf, uint32_t srcFamilyIdx = VK_QUEUE_FAMILY_IGNORED, uint32_t dstFamilyIdx = VK_QUEUE_FAMILY_IGNORED);
