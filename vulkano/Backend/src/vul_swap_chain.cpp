...
void VulSwapChain::createImageViews() {
...
void VulSwapChain::createRenderPass() {
...
void VulSwapChain::createFramebuffers() {
...
void VulSwapChain::createDepthResources() {
...
VkFormat VulSwapChain::findDepthFormat() {
