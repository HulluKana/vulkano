...
class SimpleRenderSystem{
    public:
        ...
        void init(VkRenderPass renderPass, std::vector<VkDescriptorSetLayout> setLayouts, const std::string &shadersFolder, VkFormat colorAttachmentFormat);
    ...
    private:
        ...
        void createPipeline(VkRenderPass renderPass, const std::string &shadersFolder, VkFormat colorAttachmentFormat);
